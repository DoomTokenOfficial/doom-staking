                ...
                if (mobile && tablet) {
                            ...
                            >
                                <Stack className="collapse-body">
                                    ...
                                    <Stack className="collapse-3">
                                        ...
                                        <Stack
                                            className="currency-control-box"
                                            spacing={1}
                                        >
                                            <Input
                    ...
                    return (
                        <Box>
                            <Stack
                                className="item-box"
                                onClick={(e) => handleExpand(item.id, e, index)}
                            >
                                ...
                                <Stack className="item-7">
                                    <IconButton className="mobile-expand-icon">
                                        <ChevronRightIcon
                                            className={
                                                expand[item.id] === true
                                                    ? "expand-icon activate"
                            ...
                            >
                                <Stack
                                    className="collapse-body-mobile"
                                    spacing={3}
                                >
                                    <Stack className="collapse-1">
                                        <div
                                            className="nomics-ticker-widget"
                                            data-name={item.chart.name}
                                            data-base={item.chart.id[0]}
                                            data-quote={currency}
                                        ></div>
                                    </Stack>
                                    <Stack
